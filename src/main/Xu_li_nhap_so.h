...
void Nhap_so_chinh_sua(int &n, int x, int y) // x, y la toa do con tro quay ve de nhap lai sau khi thong bao
{
	string user_string_num = "";
...
void Nhap_ngay(int &n, int x, int y) // x, y la toa do con tro quay ve de nhap lai sau khi thong bao
{
	string user_string_num = "";
...
void Nhap_thang(int &n, int x, int y) // x, y la toa do con tro quay ve de nhap lai sau khi thong bao
{
	string user_string_num = "";
...
void Nhap_nam(int &n, int x, int y) // x, y la toa do con tro quay ve de nhap lai sau khi thong bao
{
	string user_string_num = "";
